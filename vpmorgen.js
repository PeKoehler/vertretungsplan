...
var n = 1
if (heute.getDay() == 5) {n = 3}; // heute ist Freitag
if (heute.getDay() == 6) {n = 2}; // heute ist Samstag
const tag = heute.getDate(heute.setDate(heute.getDate() + n)); // Tagesdatum des nächsten Schultags, zB 13
...
async function main(){
  ...
  do {
    ...
    console.log("Seite hat ", pagedatum, " , und nächster Schultag ist der ", tag, "., Übereinstimmung ", stimmt);
